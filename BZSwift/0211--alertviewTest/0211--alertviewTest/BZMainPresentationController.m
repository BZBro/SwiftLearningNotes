...
//        self.presentingViewController.view.transform = CGAffineTransformMake(0.5, 0, 0, 0.5, 0, 0);
        self.presentingViewController.view.transform = CGAffineTransformMakeRotation(M_PI / 3);
