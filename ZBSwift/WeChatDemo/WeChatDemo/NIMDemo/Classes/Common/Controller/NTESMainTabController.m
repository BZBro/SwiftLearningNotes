    ...
    dispatch_once(&onceToken, ^{
        dict = @{
                 @(NTESMainTabTypeMessageList) : @{
                                                     ...
                                                     TabbarTitle        : @"微信",
                                                     TabbarImage        : @"tabbar_mainframe",
                                                     TabbarSelectedImage: @"tabbar_mainframeHL",
                                                     TabbarItemBadgeValue: @(self.sessionUnreadCount)
                                                  },
                 @(NTESMainTabTypeContact)     : @{
                                                     TabbarVC           : @"NTESContactViewController",
                                                     TabbarTitle        : @"通讯录",
                                                     TabbarImage        : @"tabbar_contact",
                                                     TabbarSelectedImage: @"tabbar_contactHL",
                 ...
                 @(NTESMainTabTypeSetting)     : @{
                                                     ...
                                                     TabbarSelectedImage: @"tabbar_meHL",
